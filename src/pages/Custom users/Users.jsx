...
function Users() {
        ...
        if (searchTerm) {
            ...
            filteredCustomers = filteredCustomers.filter((customer) => {
                return (
                    ...
                    customer.phone_number.toString().includes(searchLowerCase)
                );
            });
        }
    ...
    useEffect(() => {
        ...
        if (selectedCustomer) {
            ...
            setCustomerdts({
                ...
                is_favourite: selectedCustomer.is_favourite || false
            });
    ...
    const downloadExcelVip = () => {
        ...
        const worksheetData = [
            ['Name', 'Phone Number',],
            ...vipCustomers.map(customer => [customer.name, customer.phone_number])
            // Add more rows here
        ];
    ...
    const downloadExcelFavourite = () => {
        const vipCustomers = customers.filter(customer => customer.is_favourite);
        const worksheetData = [
            ['Name', 'Phone Number',],
            ...vipCustomers.map(customer => [customer.name, customer.phone_number])
            // Add more rows here
                    ...
                    <TableBody>
                        {displayedCustomer.length > 0 ? displayedCustomer.map((item, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    {item.is_VIP ? "VIP" : item.is_favourite ? "Favourite" : "Normal"}
                                </TableCell>
                ...
                <DialogContent>
                    ...
                    <FormControl variant="standard" fullWidth className='mt-3'>
                        ...
                        <Select
                            ...
                            value={
                                customerdts.is_favourite ? "Favourite" :
